...
def write_readiness_report(search: Dict[str, object]) -> Path:
    ...
    path = ARTIFACTS / ("spatial-authoring-maya-l3-readiness-%s.json" % time.strftime("%Y%m%d-%H%M%S"))
    report = {
        "reportVersion": "spatial-authoring-maya-l3-readiness@0.1.0",
        ...
        "collector": {
            ...
            "reportWhenAvailable": "spatial-authoring-maya-l3@0.1.0",
        },
        "boundary": {
