...
SCRIPT = HOST_ROOT / "scripts" / "run_blender_controlled_repair.py"
...
def _candidate_paths() -> List[Path]:
    direct = [
        ...
        Path("D:/Program Files/Blender Foundation/Blender 5.2/blender.exe"),
...
def write_readiness_report(search: Dict[str, object]) -> Path:
    ...
    path = ARTIFACTS / ("blender-controlled-repair-readiness-%s.json" % time.strftime("%Y%m%d-%H%M%S"))
    report = {
        "reportVersion": "blender-controlled-repair-readiness@0.1.0",
        ...
        "executor": {
            ...
            "reportWhenAvailable": "blender-controlled-repair-executor@0.1.0",
        },
        "boundary": {
