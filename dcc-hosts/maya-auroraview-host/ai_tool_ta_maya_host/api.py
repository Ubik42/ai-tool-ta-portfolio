...
class MayaPortfolioApi:
    ...
    def dcc_presentation_build_pack(
        self,
        label: str = "r49-groom-alembic-import-postcheck-presentation-pack",
    ) -> Dict[str, Any]:
        public_package_dir = PORTFOLIO_ROOT / "public-case-package"
        manifest_path = public_package_dir / "dcc-first-package-manifest.json"
        manifest = _read_json_dict(manifest_path)
        ...
        demo_route = [
            ...
            {
                "id": "22-run-spatial-authoring-l3",
            ...
            {
                "id": "23-run-spatial-authoring-drilldown",
            ...
            {
                "id": "24-run-unreal-socket-import-checker",
            ...
            {
                "id": "25-run-unreal-socket-authoring-executor",
            ...
            {
                "id": "26-run-platform-variant-forge",
            ...
            {
                "id": "27-run-platform-variant-unreal-runtime",
            ...
            {
                "id": "28-run-platform-variant-generation-plan",
            ...
            {
                "id": "29-run-platform-variant-texture-runtime",
            ...
            {
                "id": "30-run-platform-variant-texture-payload",
            ...
            {
                "id": "31-run-platform-variant-controlled-executor",
            ...
            {
                "id": "32-run-platform-variant-executor-expansion",
            ...
            {
                "id": "33-run-platform-variant-staticmesh-postcheck",
            ...
            {
                "id": "36-run-3dsmax-adapter-harness",
