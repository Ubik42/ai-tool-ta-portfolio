...
class MayaPortfolioApi:
    ...
    def dcc_presentation_build_pack(
        ...
        demo_route = [
            ...
            {
                "id": "20-run-spatial-authoring-l3",
            ...
            {
                "id": "21-run-spatial-authoring-drilldown",
            ...
            {
                "id": "22-run-unreal-socket-import-checker",
            ...
            {
                "id": "23-run-unreal-socket-authoring-executor",
            ...
            {
                "id": "24-run-platform-variant-forge",
            ...
            {
                "id": "25-run-platform-variant-unreal-runtime",
            ...
            {
                "id": "26-run-platform-variant-generation-plan",
            ...
            {
                "id": "27-run-platform-variant-texture-runtime",
            ...
            {
                "id": "28-run-platform-variant-texture-payload",
            ...
            {
                "id": "29-run-platform-variant-controlled-executor",
            ...
            {
                "id": "30-run-platform-variant-executor-expansion",
            ...
            {
                "id": "31-run-platform-variant-staticmesh-postcheck",
            ...
            {
                "id": "34-run-3dsmax-adapter-harness",
