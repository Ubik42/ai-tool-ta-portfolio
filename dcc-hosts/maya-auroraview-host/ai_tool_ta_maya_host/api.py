...
class MayaPortfolioApi:
    ...
    def dcc_presentation_build_pack(
        ...
        demo_route = [
            ...
            {
                "id": "28-run-platform-variant-forge",
            ...
            {
                "id": "29-run-platform-variant-unreal-runtime",
            ...
            {
                "id": "30-run-platform-variant-generation-plan",
            ...
            {
                "id": "31-run-platform-variant-texture-runtime",
            ...
            {
                "id": "32-run-platform-variant-texture-payload",
            ...
            {
                "id": "33-run-platform-variant-controlled-executor",
            ...
            {
                "id": "34-run-platform-variant-executor-expansion",
            ...
            {
                "id": "35-run-platform-variant-staticmesh-postcheck",
            ...
            {
                "id": "38-run-3dsmax-adapter-harness",
