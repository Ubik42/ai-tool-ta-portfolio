...
class MayaPortfolioApi:
    ...
    def dcc_presentation_build_pack(
        self,
        label: str = "r46-groom-export-inspector-presentation-pack",
    ) -> Dict[str, Any]:
        public_package_dir = PORTFOLIO_ROOT / "public-case-package"
        manifest_path = public_package_dir / "dcc-first-package-manifest.json"
        manifest = _read_json_dict(manifest_path)
        ...
        demo_route = [
            ...
            {
                "id": "19-run-spatial-authoring-l3",
            ...
            {
                "id": "20-run-spatial-authoring-drilldown",
            ...
            {
                "id": "21-run-unreal-socket-import-checker",
            ...
            {
                "id": "22-run-unreal-socket-authoring-executor",
            ...
            {
                "id": "23-run-platform-variant-forge",
            ...
            {
                "id": "24-run-platform-variant-unreal-runtime",
            ...
            {
                "id": "25-run-platform-variant-generation-plan",
            ...
            {
                "id": "26-run-platform-variant-texture-runtime",
            ...
            {
                "id": "27-run-platform-variant-texture-payload",
            ...
            {
                "id": "28-run-platform-variant-controlled-executor",
            ...
            {
                "id": "29-run-platform-variant-executor-expansion",
            ...
            {
                "id": "30-run-platform-variant-staticmesh-postcheck",
            ...
            {
                "id": "33-run-3dsmax-adapter-harness",
