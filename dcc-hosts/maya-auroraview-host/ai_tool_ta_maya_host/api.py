...
class MayaPortfolioApi:
    ...
    def dcc_presentation_build_pack(
        self,
        label: str = "r50-groom-plugin-api-fixture-presentation-pack",
    ) -> Dict[str, Any]:
        public_package_dir = PORTFOLIO_ROOT / "public-case-package"
        manifest_path = public_package_dir / "dcc-first-package-manifest.json"
        manifest = _read_json_dict(manifest_path)
        ...
        demo_route = [
            ...
            {
                "id": "23-run-spatial-authoring-l3",
            ...
            {
                "id": "24-run-spatial-authoring-drilldown",
            ...
            {
                "id": "25-run-unreal-socket-import-checker",
            ...
            {
                "id": "26-run-unreal-socket-authoring-executor",
            ...
            {
                "id": "27-run-platform-variant-forge",
            ...
            {
                "id": "28-run-platform-variant-unreal-runtime",
            ...
            {
                "id": "29-run-platform-variant-generation-plan",
            ...
            {
                "id": "30-run-platform-variant-texture-runtime",
            ...
            {
                "id": "31-run-platform-variant-texture-payload",
            ...
            {
                "id": "32-run-platform-variant-controlled-executor",
            ...
            {
                "id": "33-run-platform-variant-executor-expansion",
            ...
            {
                "id": "34-run-platform-variant-staticmesh-postcheck",
            ...
            {
                "id": "37-run-3dsmax-adapter-harness",
