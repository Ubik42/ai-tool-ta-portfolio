...
class MayaPortfolioApi:
    ...
    def dcc_presentation_build_pack(
        self,
        label: str = "r54-unreal-gameplay-attach-fixture-presentation-pack",
    ) -> Dict[str, Any]:
        public_package_dir = PORTFOLIO_ROOT / "public-case-package"
        manifest_path = public_package_dir / "dcc-first-package-manifest.json"
        manifest = _read_json_dict(manifest_path)
        ...
        demo_route = [
            ...
            {
                "id": "24-run-spatial-authoring-l3",
            ...
            {
                "id": "25-run-spatial-authoring-drilldown",
            ...
            {
                "id": "26-run-unreal-socket-import-checker",
            ...
            {
                "id": "27-run-unreal-socket-authoring-executor",
            ...
            {
                "id": "28-run-unreal-gameplay-attach-fixture",
            ...
            {
                "id": "29-run-platform-variant-forge",
            ...
            {
                "id": "30-run-platform-variant-unreal-runtime",
            ...
            {
                "id": "31-run-platform-variant-generation-plan",
            ...
            {
                "id": "32-run-platform-variant-texture-runtime",
            ...
            {
                "id": "33-run-platform-variant-texture-payload",
            ...
            {
                "id": "34-run-platform-variant-controlled-executor",
            ...
            {
                "id": "35-run-platform-variant-executor-expansion",
            ...
            {
                "id": "36-run-platform-variant-staticmesh-postcheck",
            ...
            {
                "id": "39-run-3dsmax-adapter-harness",
            ...
            {
                "id": "40-run-max-texture-manifest-link",
