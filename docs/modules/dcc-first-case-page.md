...
- Presenter Pack：探测 48 个关键证据文件是否存在，并把总体 gate 压成 `CapturePending` / `Review` / `Ready`。
...
- Maya 2024 `mayapy` presenter pack smoke 通过：
  ...
  - present/missing required evidence files：48 / 0
