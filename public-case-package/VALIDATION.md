...
| --- | --- | --- |
| `validate-r75-unreal-control-rig-native-bridge-build` | `python dcc-hosts/unreal-control-rig-bridge/scripts/run_control_rig_native_bridge_build.py` | RunUAT BuildPlugin compiles the public Control Rig bridge Editor plugin; gate=Ready, returnCode=0, compiledDlls=1, errorLines=0, compilerVersion=14.38.33130, configRestored=true and productionWrites=0. |
| `validate-r75-dcc-presenter-pack` | `Maya mayapy dcc_presentation_export_pack(label="r75-unreal-control-rig-native-bridge-build-presentation-pack")` | DCC Presenter Pack probes 73 key evidence files including the Unreal Control Rig Native Bridge Build artifact, reports 73 present / 0 missing required files, and exports 63 demo route steps. |
| `validate-r74-unreal-control-rig-native-bridge-readiness` | `python dcc-hosts/unreal-control-rig-bridge/scripts/run_control_rig_native_bridge_readiness.py` | UE 5.3 runtime enters the public project, Control Rig / RigVM classes are visible, native bridge source is complete, missingRequiredNativeFiles=0, compiledBridgeBinary=false and commandletVisible=false remain explicit gates, productionWrites=0. |
| `validate-r74-dcc-presenter-pack` | `Maya mayapy dcc_presentation_export_pack(label="r74-unreal-control-rig-native-bridge-readiness-presentation-pack")` | DCC Presenter Pack probes 72 key evidence files including the Unreal Control Rig Native Bridge Readiness artifact, reports 72 present / 0 missing required files, and exports 62 demo route steps. |
| `validate-r73-unreal-gameplay-attach-timing-controlled-readiness` | `python dcc-hosts/unreal-animation-bridge/scripts/run_gameplay_attach_timing_controlled_readiness.py` | Derived readiness joins controlled socket write, attach timing readiness and native notify controlled write; gate=Review, timingReadyByControlledWrite=1, heldBySocketOrSource=1, missingAttachTimingEventsAfterControlledWrite=0, productionWrites=0 and finalHashRestored=true. |
| `validate-r73-dcc-presenter-pack` | `Maya mayapy dcc_presentation_export_pack(label="r73-unreal-gameplay-attach-timing-controlled-readiness-presentation-pack")` | DCC Presenter Pack probes 71 key evidence files including the gameplay attach timing controlled readiness artifact, reports 71 present / 0 missing required files, and exports 61 demo route steps. |
| `validate-r72-unreal-animation-notify-native-build` | `python dcc-hosts/unreal-animation-bridge/scripts/run_anim_notify_native_bridge_build.py` | Rebuilds the controlled-write capable Anim Notify bridge; gate=Ready, returnCode=0, compiledDlls=1, errorLines=0, compilerVersion=14.38.33130, configRestored=true and productionWrites=0. |
| `validate-r72-unreal-animation-notify-native-controlled-write` | `python dcc-hosts/unreal-animation-bridge/scripts/run_anim_notify_native_controlled_write.py` | Packaged Anim Notify bridge commandlet writes 2 required attach timing events into temp public AnimSequences, post-checks both, rolls them back, restores `.uasset` hashes, and records productionWrites=0 / persistentMutation=false. |
| `validate-r72-dcc-presenter-pack` | `Maya mayapy dcc_presentation_export_pack(label="r72-unreal-animation-notify-native-controlled-write-presentation-pack")` | DCC Presenter Pack probes 70 key evidence files including the Unreal Animation Notify Native Controlled Write artifact, reports 70 present / 0 missing required files, and exports 60 demo route steps. |
| `validate-r71-unreal-animation-notify-native-diagnostics` | `python dcc-hosts/unreal-animation-bridge/scripts/run_anim_notify_native_diagnostics.py` | Packaged Anim Notify bridge commandlet loads R67 AnimSequence paths; returnCode=0, commandletLoaded=true, outputStatus=diagnostics_completed, loadedSequences=2/2, notifyRows=0, missingAttachTimingEvents=2 and productionWrites=0, so runtime succeeds while business gate remains Blocked. |
| `validate-r71-dcc-presenter-pack` | `Maya mayapy dcc_presentation_export_pack(label="r71-unreal-animation-notify-native-diagnostics-presentation-pack")` | DCC Presenter Pack probes 69 key evidence files including the Unreal Animation Notify Native Diagnostics artifact, reports 69 present / 0 missing required files, and exports 59 demo route steps. |
| `validate-r70-unreal-animation-notify-native-commandlet` | `python dcc-hosts/unreal-animation-bridge/scripts/run_anim_notify_native_commandlet_probe.py` | Packaged Anim Notify bridge loads in a temp Unreal 5.3 project; gate=Ready, returnCode=0, commandletLoaded=true, readinessInvocation=true, outputStatus=readiness_invocation_only, errorLines=0 and productionWrites=0. |
| `validate-r70-dcc-presenter-pack` | `Maya mayapy dcc_presentation_export_pack(label="r70-unreal-animation-notify-native-commandlet-presentation-pack")` | DCC Presenter Pack probes 68 key evidence files including the Unreal Animation Notify Native Commandlet Probe artifact, reports 68 present / 0 missing required files, and exports 58 demo route steps. |
| `validate-r69-unreal-animation-notify-native-build` | `python dcc-hosts/unreal-animation-bridge/scripts/run_anim_notify_native_bridge_build.py` | RunUAT BuildPlugin compiles the public Anim Notify bridge Editor plugin; gate=Ready, returnCode=0, compiledDlls=1, errorLines=0, compilerVersion=14.38.33130, configRestored=true and productionWrites=0. |
| `validate-r69-dcc-presenter-pack` | `Maya mayapy dcc_presentation_export_pack(label="r69-unreal-animation-notify-native-build-presentation-pack")` | DCC Presenter Pack probes 67 key evidence files including the Unreal Animation Notify Native Bridge Build artifact, reports 67 present / 0 missing required files, and exports 57 demo route steps. |
| `validate-r68-unreal-animation-notify-native-bridge` | `python dcc-hosts/unreal-animation-bridge/scripts/run_anim_notify_native_bridge_readiness.py` | R67 attach timing gaps are grounded in a UE native bridge source contract; gate=Blocked only because compiled binary and commandlet visibility are not proven yet, while runtimeEntered=true, animSequenceClassesVisible=true, hasNativeSource=true, missingRequiredNativeFiles=0 and productionWrites=0. |
| `validate-r68-dcc-presenter-pack` | `Maya mayapy dcc_presentation_export_pack(label="r68-unreal-animation-notify-native-bridge-presentation-pack")` | DCC Presenter Pack probes 66 key evidence files including the Unreal Animation Notify Native Bridge Readiness artifact, reports 66 present / 0 missing required files, and exports 56 demo route steps. |
| `validate-r67-unreal-animation-attach-timing-readiness` | `python dcc-hosts/unreal-animation-bridge/scripts/run_attach_timing_readiness.py` | R66 gameplay readiness is linked to AnimSequence deep facts; gate=Blocked, timingBlocked=1, heldBySocketOrSource=1, notifyReadableIntents=0, missingAttachTimingEvents=2 and productionWrites=0. |
| `validate-r67-dcc-presenter-pack` | `Maya mayapy dcc_presentation_export_pack(label="r67-unreal-animation-attach-timing-readiness-presentation-pack")` | DCC Presenter Pack probes 65 key evidence files including the Unreal Animation Attach Timing Readiness artifact, reports 65 present / 0 missing required files, and exports 55 demo route steps. |
| `validate-r65-unreal-socket-native-build` | `python dcc-hosts/unreal-socket-import-checker/scripts/run_native_bridge_build.py` | Unreal Automation Tool BuildPlugin compiles the controlled-write `AI_Tool_TA_SocketBridge` Editor plugin into a Win64 DLL; returnCode=0, compiledDlls=1, errorLines=0, MSVC 14.38.33130, configRestored=true and productionWrites=0. |
| `validate-r65-unreal-socket-native-controlled-write` | `python dcc-hosts/unreal-socket-import-checker/scripts/run_native_controlled_write.py` | Unreal 5.3 temp project loads the packaged commandlet, applies 2 approved sockets to the public Skeleton, saves, post-checks presence, rolls back both sockets, restores the uasset hash and records productionWrites=0. |
| `validate-r66-dcc-presenter-pack` | `Maya mayapy dcc_presentation_export_pack(label="r66-unreal-gameplay-attach-controlled-readiness-presentation-pack")` | DCC Presenter Pack probes 64 key evidence files including the Unreal Gameplay Attach Controlled Readiness artifact, reports 64 present / 0 missing required files, and exports 54 demo route steps. |
| `validate-r66-unreal-gameplay-attach-controlled-readiness` | `python dcc-hosts/unreal-socket-import-checker/scripts/run_gameplay_attach_controlled_readiness.py` | R54 gameplay attach fixture linked to R65 native controlled write: gate=Review, readyByControlledExecutor=1, heldBySourceOwner=1, fullFixtureGate=Blocked, productionWrites=0, finalHashRestored=true. |
| `validate-r65-dcc-presenter-pack` | `Maya mayapy dcc_presentation_export_pack(label="r65-unreal-socket-native-controlled-write-presentation-pack")` | DCC Presenter Pack probes 63 key evidence files including the Unreal Socket Native Controlled Write artifact, reports 63 present / 0 missing required files, and exports 53 demo route steps. |
| `validate-r64-unreal-socket-native-build` | `python dcc-hosts/unreal-socket-import-checker/scripts/run_native_bridge_build.py` | Unreal Automation Tool BuildPlugin compiles the receipt-aware `AI_Tool_TA_SocketBridge` Editor plugin into a Win64 DLL; returnCode=0, compiledDlls=1, errorLines=0, MSVC 14.38.33130, configRestored=true and productionWrites=0. |
| `validate-r64-unreal-socket-native-receipt-dryrun` | `python dcc-hosts/unreal-socket-import-checker/scripts/run_native_receipt_dryrun.py` | Unreal 5.3 temp project loads the packaged commandlet, parses the approved JSON socket receipt, loads the public Skeleton, reports 2 wouldCreate rows, and records assetWrites / engineWrites / productionWrites = 0 / 0 / 0. |
| `validate-r64-dcc-presenter-pack` | `Maya mayapy dcc_presentation_export_pack(label="r64-unreal-socket-native-receipt-dryrun-presentation-pack")` | DCC Presenter Pack probes 62 key evidence files including the Unreal Socket Native Receipt Dry-run artifact, reports 62 present / 0 missing required files, and exports 52 demo route steps. |
| `validate-r63-unreal-socket-native-commandlet-probe` | `python dcc-hosts/unreal-socket-import-checker/scripts/run_native_commandlet_probe.py` | Unreal 5.3 loads the R62 packaged socket bridge plugin in a temp project and executes `-run=AiToolTaSocketAuthoring`; returnCode=0, commandletLoaded=true, readinessInvocation=true, errorLines=0 and productionWrites=0. |
| `validate-r63-dcc-presenter-pack` | `Maya mayapy dcc_presentation_export_pack(label="r63-unreal-socket-native-commandlet-presentation-pack")` | DCC Presenter Pack probes 61 key evidence files including the Unreal Socket Native Commandlet Probe artifact, reports 61 present / 0 missing required files, and exports 51 demo route steps. |
| `validate-r62-unreal-socket-native-build` | `python dcc-hosts/unreal-socket-import-checker/scripts/run_native_bridge_build.py` | Unreal Automation Tool BuildPlugin compiles the public `AI_Tool_TA_SocketBridge` Editor plugin source with compatible UE 5.3 MSVC, emits a hashed Win64 Editor DLL under `D:\cs\_test`, reports returnCode=0 and errorLines=0, then restores the temporary UBT compiler config. |
| `validate-r62-dcc-presenter-pack` | `Maya mayapy dcc_presentation_export_pack(label="r62-unreal-socket-native-build-presentation-pack")` | DCC Presenter Pack probes 60 key evidence files including the Unreal Socket Native Bridge Build Harness artifact, reports 60 present / 0 missing required files, and exports 50 demo route steps. |
| `validate-r61-unreal-socket-native-bridge-source` | `python dcc-hosts/unreal-socket-import-checker/scripts/run_native_bridge_readiness.py` | Unreal 5.3.2 headless runtime verifies socket/editor utility APIs and confirms the public `AI_Tool_TA_SocketBridge` source/plugin contract is present with 0 required source files missing; binary and commandlet visibility remain blocked until the Editor module is built. |
| `validate-r61-dcc-presenter-pack` | `Maya mayapy dcc_presentation_export_pack(label="r61-unreal-socket-native-source-presentation-pack")` | DCC Presenter Pack probes 59 key evidence files including the updated Unreal Socket Native Bridge Source Readiness artifact, reports 59 present / 0 missing required files, and exports 49 demo route steps. |
| `validate-r60-unreal-socket-native-bridge` | `python dcc-hosts/unreal-socket-import-checker/scripts/run_native_bridge_readiness.py` | Unreal 5.3.2 headless runtime verifies socket classes and Editor Utility surface are visible, links back to the R40 API-limited Python executor, and blocks native socket authoring until the `AI_Tool_TA_SocketBridge` source/plugin/binary/commandlet surface exists. |
| `validate-r60-dcc-presenter-pack` | `Maya mayapy dcc_presentation_export_pack(label="r60-unreal-socket-native-bridge-presentation-pack")` | DCC Presenter Pack probes 59 key evidence files including Unreal Socket Native Bridge Readiness, reports 59 present / 0 missing required files, and exports 49 demo route steps. |
