...
pack = MayaPortfolioApi().dcc_presentation_build_pack(label="r71-unreal-animation-notify-native-diagnostics-presentation-pack")
summary = pack["summary"]
assert summary["package_version"] == "dcc-first-package@1.68.0", summary
assert summary["present_evidence_files"] == 69, summary
assert summary["missing_required_files"] == 0, summary
assert summary["demo_route_steps"] == 59, summary
