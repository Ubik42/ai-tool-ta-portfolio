param(
    [ValidateSet("quick", "package", "ui", "animation", "unreal-animation", "unreal-animation-deep-facts", "character-calibration", "character-drilldown", "unreal-control-rig", "unreal-control-rig-fixture-authoring", "unreal-control-rig-deformation-link", "spatial-authoring", "spatial-drilldown", "unreal-socket", "unreal-socket-authoring-executor", "platform-variant", "platform-variant-unreal", "platform-variant-generation", "platform-variant-texture", "platform-variant-texture-payload", "platform-variant-executor", "platform-variant-executor-expansion", "platform-variant-staticmesh-postcheck", "blender", "max", "full")]
    [string]$Tier = "quick",
...
pack = MayaPortfolioApi().dcc_presentation_build_pack(label="r43-unreal-control-rig-deformation-link-presentation-pack")
summary = pack["summary"]
assert summary["present_evidence_files"] == 41, summary
assert summary["missing_required_files"] == 0, summary
assert summary["demo_route_steps"] == 32, summary
