...
pack = MayaPortfolioApi().dcc_presentation_build_pack(label="r70-unreal-animation-notify-native-commandlet-presentation-pack")
summary = pack["summary"]
assert summary["package_version"] == "dcc-first-package@1.67.0", summary
assert summary["present_evidence_files"] == 68, summary
assert summary["missing_required_files"] == 0, summary
assert summary["demo_route_steps"] == 58, summary
